                    ...
                    <tr key={"product" + index}>
                        {
                            ...
                            onEditProductId !== product._id && <Fragment>
                        ...
                        {
                            onEditProductId === product._id && <Fragment>
                                <td><input type='text' name='brandName' defaultValue={ product.brandName } /></td>
                                <td><input type='text' name='name' defaultValue={ product.name } /></td>
                            </Fragment>
                        }
                        {
                            onUpdateProduct && <td>
                                {
                                    onEditProductId !== product._id && <button
                                        onClick={ (event) => {
                        ...
                        {onRemoveProductFromWishlist && <td>
                            <button
                                onClick={ () => {
